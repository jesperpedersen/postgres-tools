...
wget https://oss.sonatype.org/content/groups/public/com/github/jsqlparser/jsqlparser/2.0/jsqlparser-2.0.jar
/path/to/javac -classpath jsqlparser-2.0.jar QueryAnalyzer.java
```
...
```bash
cd /path/to/work_area
/path/to/java -classpath .:postgresql-42.2.5.jar:jsqlparser-2.0.jar QueryAnalyzer
```
...
```bash
cd /path/to/work_area
/path/to/java -classpath .:postgresql-42.2.5.jar:jsqlparser-2.0.jar QueryAnalyzer -c myprops.properties
```
